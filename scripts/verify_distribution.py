...
REQUIRED_WHEEL_FILES = {
    ...
    "aiteqno/ports/ocr_grouping.py",
    "aiteqno/ports/ocr_language.py",
    ...
    "aiteqno/application/ocr_grouping.py",
    "aiteqno/application/ocr_language.py",
    "aiteqno/application/ocr_padding.py",
    "aiteqno/application/ocr_quality.py",
    "aiteqno/application/ocr_resolution.py",
    "aiteqno/application/ocr_region_grouping.py",
